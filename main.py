...
class SettingsDialog(QDialog):
    def __init__(self, parent = None):
        ...
        layout.addWidget(self.input_field, 2,0,1,2)
        ...
        layout.addWidget(prompt_name_label, 4, 0, 1, 2)
        ...
        layout.addWidget(self.prompt_name_input, 5, 0, 1, 2)
        ...
        layout.addWidget(self.prompt_edit, 6, 0, 1, 2)
        ...
        layout.addWidget(update_prompt_button, 10, 0, 1, 2)
        ...
        layout.addWidget(update_agg_button, 17, 0, 1, 2)
